...
#if 0
INT WINAPI WinMainx(HINSTANCE hInst, HINSTANCE ignoreMe0, LPSTR ignoreMe1, INT ignoreMe2) {
...
LRESULT WINAPI MsgProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    switch(msg) {
        case WM_RBUTTONUP:
            PezHandleMouse(x, y, PEZ_UP | PEZ_RIGHT);
            break;

        case WM_RBUTTONDOWN:
            PezHandleMouse(x, y, PEZ_DOWN | PEZ_RIGHT);
            break;
        ...
        case WM_MOUSEMOVE:
            if(GetAsyncKeyState(VK_LBUTTON) & 0x8000) {
                PezHandleMouse(x, y, PEZ_MOVE | PEZ_DOWN | PEZ_LEFT);
            }
            if(GetAsyncKeyState(VK_RBUTTON) & 0x8000) {
                PezHandleMouse(x, y, PEZ_MOVE | PEZ_DOWN | PEZ_RIGHT);
            }
            break;
